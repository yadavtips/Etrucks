								...
								<tbody>
									...
									<tr >
										...
										<td style="text-align: center;">@if($c->assigned_to =='')   
											Assign First
												@else
											<a  href="https://wa.me/91{{$c->phone}}?text=Thank%20you%20for%20getting%20in%20touch%21%0A%0AYour%20Mobile%20No.%20%3D%20%20{{$c->phone}}%0ATruck%20required%20%3D%20{{$c->vehicle_type}}%0ALoad%20from%20%3D%20{{$c->load_from}}%0ADispatch%20to%20%3D%20{{$c->dispatch_to}}%0A%0AYour%20job%20is%20assigned%20to%20{{$c->assigned_to}}.%20He%20will%20call%20you%20soon.%0A%0AIf%20have%20any%20queries%20please%20call%20us%209717940842%2011%20am%20to%206%20pm" target="_blank"><i class="fab fa-whatsapp fa-lg "style="color:grey;"></i></a>
											@endif
										</td>
									<td>
										@if ($c->lead_status == '')
