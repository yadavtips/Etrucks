...
@endif
  ...
  <label for="truck">Truck</label><br>
                    ...
                    <div class="row">
                        <div class="col">
                            <label class="form-label" for="name">Load From</label>
                          <input type="text" name="load_from"  class="form-control" value="{{$job->load_from}}" placeholder="Load From" required>
                        </div>
                        <div class="col">
                            <label class="form-label" for="name">Dispatch To</label>
                          <input type="text" name="dispatch_to"  class="form-control" value="{{$job->dispatch_to}}" placeholder="Dispatch To" required>
                        </div>
                     </div>
                    <br/>
                    <div class="row">
